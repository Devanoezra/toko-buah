			...
			<tbody>
				...
				foreach ($buah as $bk) : $no++; ?>
					...
					<tr>
						...
						<td> <a href="<?= base_url('index.php/Cart/tambah_cart/' . $bk->kode_buah) ?>" class="btn btn-success">Buy</a></td>
	...
	<div class="col-md-5">
		...
		<form action="<?= base_url('index.php/Transaksi/transaksi') ?>" method="post">
			...
			<table class="table table-stripped table-hover">
				...
				<?php $no = 0;
				foreach ($this->cart->contents() as $ct) : $no++; ?>

					<input type="hidden" name="kode_buah[]" value="<?= $ct['id'] ?>">
				...
				<tr>
					<td colspan="2"><input type="submit" value="Pay" name="bayar" class="btn btn-success"></td>
					<td colspan="2"><a href="<?= base_url('index.php/Cart/hapus_semua_cart') ?>" class="btn btn-danger" onclick="return confirm('apakah anda yakin untuk menghapus semua pesanan')">Delete Cart</a>
					<!-- </td>
